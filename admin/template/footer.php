   <!--main content end-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              <?php echo date('Y');?> - Sistem Penjualan Barang Dan Inventory Berbasis Web | 
              By <a href="https://www.instagram.com/rzkyisml/" style="color:yellow;font-weight:700;" target="_blank">Ismaul Rizki</a>
              <a href="#" class="go-top">
